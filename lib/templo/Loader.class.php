...
class templo_Loader {
	...
	public function compileTemplate($path) {
		...
		if(file_exists($tmpFile)) {
			$macroStamp = ((templo_Loader::$MACROS !== null && file_exists(_hx_string_or_null(templo_Loader::$BASE_DIR) . _hx_string_or_null(templo_Loader::$MACROS))) ? sys_FileSystem::stat(_hx_string_or_null(templo_Loader::$BASE_DIR) . _hx_string_or_null(templo_Loader::$MACROS))->mtime->getTime() : null);
